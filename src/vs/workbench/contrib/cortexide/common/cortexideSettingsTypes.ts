...
export type ChatMode = 'agent' | 'gather' | 'normal' | 'plan' | 'spec'

// Spec mode phase for structured development workflow (like Kiro)
export type SpecPhase = 'requirements' | 'design' | 'tasks' | 'implement'
...
export type GlobalSettings = {
	...
	enableLifecycleHooks?: boolean; // Run user-configured .cortexide/hooks.json commands at agent lifecycle events (pre-tool/post-tool/agent-stop) (default: true)
	// Audit log settings
	audit?: {
...
export const defaultGlobalSettings: GlobalSettings = {
	...
	enableLifecycleHooks: true, // Opt-in: run .cortexide/hooks.json commands at agent lifecycle events
