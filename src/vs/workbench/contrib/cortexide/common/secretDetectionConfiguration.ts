...
export class SecretDetectionConfigurationContribution extends Disposable implements IWorkbenchContribution {
	...
	constructor() {
		...
		registry.registerConfiguration({
			id: 'cortexide.secretDetection',
			title: localize('secretDetection.title', 'Secret Detection'),
			type: 'object',
			properties: {
				'cortexide.secretDetection.enabled': {
					type: 'boolean',
					default: true,
				...
				'cortexide.secretDetection.mode': {
					type: 'string',
					enum: ['block', 'redact'],
					enumDescriptions: [
				...
				'cortexide.secretDetection.disabledPatternIds': {
					type: 'array',
					items: {
						type: 'string',
					},
				...
				'cortexide.secretDetection.customPatterns': {
					type: 'array',
					items: {
						type: 'object',
						properties: {
