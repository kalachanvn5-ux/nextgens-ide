		...
		>
			{attachments.map((attachment, index) => {
				...
				return (
					...
					>
						{/* Preview area */}
						<div className="relative flex-1 w-full overflow-hidden bg-void-bg-1 flex items-center justify-center">
							{attachment.pagePreviews && attachment.pagePreviews.length > 0 ? (
								...
								<FileText className="w-12 h-12 text-void-fg-3" />
							)}
						...
						{/* Info section */}
						<div className="px-2 py-1.5 bg-void-bg-2-alt border-t border-void-border-3">
							<div className="text-xs font-medium text-void-fg-1 truncate" title={attachment.filename}>
								{attachment.filename}
							</div>
