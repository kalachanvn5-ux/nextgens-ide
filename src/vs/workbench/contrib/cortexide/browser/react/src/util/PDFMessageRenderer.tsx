...
export const PDFMessageRenderer: React.FC<PDFMessageRendererProps> = ({
	...
	return (
		<div className="flex flex-col gap-2">
			{/* Caption text */}
			{caption && (
				<div className="text-void-fg-1 whitespace-pre-wrap break-words">
					{caption}
				</div>
			)}
						...
						>
							<div
								className={`
									...
									group-hover:border-void-border-1
									${gridCols === 1 ? 'max-h-[320px] md:max-h-[400px]' : 'aspect-[3/4] max-h-[240px] md:max-h-[300px]'}
								`}
							>
								{/* Preview area */}
								<div className="w-full h-full flex items-center justify-center bg-void-bg-1">
									{hasPreview ? (
										<img
